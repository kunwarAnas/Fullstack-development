...
const Cart = () => {
  ...
  useEffect(() => {
    ...
    setItems(JSON.parse(data as string));
    ...
    <section className="py-24 relative">
      <div className="w-full max-w-7xl px-4 md:px-5 lg-6 mx-auto">
          ...
          items.map((item: any) => (
            ...
            >
              ...
              <div className="col-span-12 lg:col-span-10 detail w-full lg:pl-3">
                ...
                {/* <p className="font-normal text-base leading-7 mb-6">
        ...
        <div className="flex flex-col md:flex-row items-center md:items-center justify-between lg:px-6 pb-6 border-b border-gray-200 max-lg:max-w-lg max-lg:mx-auto">
          <h5 className="text font-manrope font-semibold text-2xl leading-9 w-full max-md:text-center max-md:mb-4">
            Subtotal
          </h5>
        ...
        <div className="max-lg:max-w-lg max-lg:mx-auto">
          <p className="font-normal text-base leading-7 text text-center mb-5 mt-6">
